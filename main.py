...
other_system = PlanetSystem(rotation_center_distance=30)
...
scene.add_system(PlanetSystem(rotation_center_distance=60, planets=[Planet(color=[0, .5, 1])]))
scene.make_gif(duration=20)
'''scene.make_png(56)
scene.show(width=700, height=700)
'''